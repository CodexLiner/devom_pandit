package com.devom.pandit.ui.screens.withdraw
...
import com.devom.pandit.ui.screens.wallet.WalletBalanceInfo
import com.devom.pandit.ui.screens.wallet.WalletIcon
import com.devom.pandit.ui.screens.wallet.WalletViewModel
        ...
        TextInputField(
            ...
            amount = when {
                input.all { it.isDigit() } -> {
                    ...
                    if (value != null && value > balance.toInt()) balance.toInt().toString() else input
                }
