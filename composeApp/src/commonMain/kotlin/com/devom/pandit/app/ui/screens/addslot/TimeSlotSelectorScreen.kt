package com.devom.pandit.app.ui.screens.addslot
...
import com.devom.pandit.app.theme.inputColor
...
import com.devom.pandit.app.ui.components.DateItem
import com.devom.pandit.app.utils.dashedBorder
import com.devom.pandit.app.utils.format12HourTime
import com.devom.pandit.app.utils.parse12HourTime
import com.devom.pandit.app.utils.to12HourTime
import com.devom.pandit.app.utils.toTimeParts
import com.devom.pandit.app.utils.updateSlotTimeAndShiftFollowingSlots
            ...
            ButtonPrimary(
                ...
                val normalizedInitialSlots = initialSelectedSlots.mapNotNull { slot ->
                    slot.availableDate.convertIsoToDate()
                        ...
                        ?.let { normalizedDate ->
                            slot.copy(
                                availableDate = normalizedDate.toString(),
                                startTime = LocalTime.parse(slot.startTime).toAmPm(),
                                endTime = LocalTime.parse(slot.endTime).toAmPm()
                            )
                        }
                }
