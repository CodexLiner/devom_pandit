package com.devom.pandit.app.ui.screens.signup.fragments
...
import com.devom.pandit.app.ui.components.DatePickerDialog
    ...
    Column(
        ...
        ExposedDropdown(
            ...
            selectedOption = DropDownItem(
                option = selectedCountry.value?.name.orEmpty(),
                selectedCountry.value?.isoCode.orEmpty()
            ),
        ...
        ExposedDropdown(
            ...
            selectedOption = DropDownItem(
                option = selectedState.value?.name.orEmpty(),
                selectedState.value?.isoCode.orEmpty()
            ),
        ...
        ExposedDropdown(
            ...
            selectedOption = DropDownItem(
                option = selectedCity.value?.name.orEmpty(),
                selectedCity.value?.isoCode.orEmpty()
            ),
